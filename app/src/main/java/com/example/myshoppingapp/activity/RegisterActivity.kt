...
import com.example.myshoppingapp.modal.UserDetails
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun storeData() {
        ...
        val data = UserDetails(userName = binding.userName.text.toString(), userPhoneNumber = binding.userNumber.text.toString())
